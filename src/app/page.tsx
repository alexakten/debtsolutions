...
export default function Landing() {
  return (
    <main className="relative flex tracking-tight flex-col items-center px-3 text-center bg-[#F9F9F9] text-zinc-900 sm:px-8 2xl:text-lg">
      ...
      <section className="flex mt-48 w-full max-w-8xl flex-col justify-center items-center">
        ...
        <button className="px-6 mt-10 py-2 rounded-full tracking-normal text-white bg-black hover:bg-purple ">
          Get started <span className={inter.className}>-&gt;</span>
        </button>
      </section>

      <section className="grid max-w-6xl m-20 grid-cols-4 w-full gap-4">
